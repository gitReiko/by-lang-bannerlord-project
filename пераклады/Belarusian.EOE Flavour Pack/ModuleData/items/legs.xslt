<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="Item[@id='eoe_eng_stripchasseus1']/@name">
        <xsl:attribute name="name">{=eoe_eng_stripchasseus1.name}[EOE LOWER BODY] Decorated Mail Chasseus, Blue and White Stripes</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_chasseus_shoespur1']/@name">
        <xsl:attribute name="name">{=eoe_chasseus_shoespur1.name}[EOE LOWER BODY] Decorated Mail Chasseus, Red and Yellow Stripes</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_mailchasseus_stirrup1']/@name">
        <xsl:attribute name="name">{=eoe_mailchasseus_stirrup1.name}[EOE LOWER BODY] Mail Chasseus, Spurs</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_footman_chasseus1']/@name">
        <xsl:attribute name="name">{=eoe_footman_chasseus1.name}[EOE LOWER BODY] Footmans Mail Chasseus</xsl:attribute>
    </xsl:template>
