<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="Item[@id='eoe_fur_cape_1']/@name">
        <xsl:attribute name="name">{=eoe_fur_cape_1.name}[EOE CAPE] Fur with Cape, Dark Common</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_we_unicloak_11']/@name">
        <xsl:attribute name="name">{=eoe_we_unicloak_11.name}[EOE CAPE] Western Common Cape, Broche</xsl:attribute>
    </xsl:template>
    ...
    <xsl:template match="Item[@id='eoe_commoncloak2']/@name">
        <xsl:attribute name="name">{=eoe_commoncloak2.name}[EOE CAPE] Common Cloak, Green</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_commoncloak1']/@name">
        <xsl:attribute name="name">{=eoe_commoncloak1.name}[EOE CAPE] Common Cloak, Dark</xsl:attribute>
    </xsl:template>
    ...
    <xsl:template match="Item[@id='eoe_coronation_cape1']/@name">
        <xsl:attribute name="name">{=eoe_coronation_cape1.name}[EOE CAPE] Coronation Cape 1</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_coronation_cape2']/@name">
        <xsl:attribute name="name">{=eoe_coronation_cape2.name}[EOE CAPE] Coronation Cape 2</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_coronation_cape3']/@name">
        <xsl:attribute name="name">{=eoe_coronation_cape3.name}[EOE CAPE] Coronation Cape 3</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_coronation_cape4']/@name">
        <xsl:attribute name="name">{=eoe_coronation_cape4.name}[EOE CAPE] Coronation Cape 4</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_coronation_cape5']/@name">
        <xsl:attribute name="name">{=eoe_coronation_cape5.name}[EOE CAPE] Coronation Cape 5</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_coronation_cape6']/@name">
        <xsl:attribute name="name">{=eoe_coronation_cape6.name}[EOE CAPE] Coronation Cape 6</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_wecommonercape_1']/@name">
        <xsl:attribute name="name">{=eoe_wecommonercape_1.name}[EOE CAPE] Western Broche Cloak 1, Commoner</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_anglocloak_1']/@name">
        <xsl:attribute name="name">{=eoe_anglocloak_1.name}[EOE CAPE] Anglo Broche Cloak 1</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_decorativewe_cape1']/@name">
        <xsl:attribute name="name">{=eoe_decorativewe_cape1.name}[EOE CAPE] Western Decorative Broche Cloak 1</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_decorativewe_cape2']/@name">
        <xsl:attribute name="name">{=eoe_decorativewe_cape2.name}[EOE CAPE] Western Decorative Broche Cloak 2</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_decorativewe_cape3']/@name">
        <xsl:attribute name="name">{=eoe_decorativewe_cape3.name}[EOE CAPE] Western Decorative Broche Cloak 3</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_decorativewe_cape4']/@name">
        <xsl:attribute name="name">{=eoe_decorativewe_cape4.name}[EOE CAPE] Western Decorative Broche Cloak 4</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_decorativewe_cape5']/@name">
        <xsl:attribute name="name">{=eoe_decorativewe_cape5.name}[EOE CAPE] Western Decorative Broche Cloak 5</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_baltofinnic2']/@name">
        <xsl:attribute name="name">{=eoe_baltofinnic2.name}[EOE CAPE] Balto Finnic Cloak 2</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_baltofinnic1']/@name">
        <xsl:attribute name="name">{=eoe_baltofinnic1.name}[EOE CAPE] Balto Finnic Cloak 1</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_furcloak1']/@name">
        <xsl:attribute name="name">{=eoe_furcloak1.name}[EOE CAPE] Fur Cloak, Broche 1</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_furcloak2']/@name">
        <xsl:attribute name="name">{=eoe_furcloak2.name}[EOE CAPE] Fur Cloak, Broche 2</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_1']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_1.name}[EOE CAPE] Decorated Western Cloak 1</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_2']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_2.name}[EOE CAPE] Decorated Western Cloak 2</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_3']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_3.name}[EOE CAPE] Decorated Western Cloak 3</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_4']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_4.name}[EOE CAPE] Decorated Western Cloak 4</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_5']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_5.name}[EOE CAPE] Decorated Western Cloak 5</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_6']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_6.name}[EOE CAPE] Decorated Western Cloak 6</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_7']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_7.name}[EOE CAPE] Decorated Western Cloak 7</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_8']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_8.name}[EOE CAPE] Decorated Western Cloak 8</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_newcloak_9']/@name">
        <xsl:attribute name="name">{=eoe_newcloak_9.name}[EOE CAPE] Decorated Western Cloak 9</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_engplaid_cloak_1']/@name">
        <xsl:attribute name="name">{=eoe_engplaid_cloak_1.name}[EOE CAPE] Anglo Embroided Cape, Knight</xsl:attribute>
    </xsl:template>
