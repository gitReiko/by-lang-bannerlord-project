<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="Item[@id='eoe_andalusianhelmet1_mail']/@name">
        <xsl:attribute name="name">{=eoe_andalusianhelmet1_mail.name}[EOE ANDALUSIAN HELMET] Andalusian Cervelliere, Decorated, Veiled Mail Coif 1</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='eoe_andalusianhelmet2_mail']/@name">
        <xsl:attribute name="name">{=eoe_andalusianhelmet2_mail.name}[EOE ANDALUSIAN HELMET] Andalusian Cervelliere, Decorated, Veiled Mail Coif 2</xsl:attribute>
    </xsl:template>
