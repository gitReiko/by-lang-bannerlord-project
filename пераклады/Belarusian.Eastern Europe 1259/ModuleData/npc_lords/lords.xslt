...
<xsl:output omit-xml-declaration="yes"/>
    ...
    <xsl:template match="NPCCharacter[@id='lord_4_1']">
        <NPCCharacter id="lord_4_1" name="{=lord_4_1.name}Sareika" voice="earnest" age="31" is_female="false" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_4_2']">
        <NPCCharacter id="lord_4_2" name="{=lord_4_2.name}Audra" voice="ironic" age="27" is_female="true" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_6_1']">
        <NPCCharacter id="lord_6_1" name="{=lord_6_1.name}Lamekins" voice="softspoken" age="59" is_female="false" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry" text="">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_6_2']">
        <NPCCharacter id="lord_6_2" name="{=lord_6_2.name}Aina" voice="curt" age="52" is_female="true" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_5_1']">
        <NPCCharacter id="lord_5_1" name="{=lord_5_1.name}Šabis" voice="earnest" age="42" is_female="false" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_2_1']">
        <NPCCharacter id="lord_2_1"{=lord_lit_4_2.name}Skomantas" voice="ironic" age="32" is_female="false" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_2_2']">
        <NPCCharacter id="lord_2_2" name="{=lord_2_2.name}Milda" voice="softspoken" age="25" is_female="true" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_3_1']">
        <NPCCharacter id="lord_3_1" name="{=lord_3_1.name}Glappo" voice="curt" age="33" is_female="false" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_3_2']">
        <NPCCharacter id="lord_3_2" name="{=lord_3_2.name}Vaida" voice="earnest" age="25" is_female="true" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_1_14']">
        <NPCCharacter id="lord_1_14" name="{=lord_1_14.name}Synko" voice="ironic" age="30" is_female="false" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_1_1']">
        <NPCCharacter id="lord_1_1" name="{=lord_1_1.name}Erks Mānts" voice="curt" age="32" is_female="false" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_1_2']">
        <NPCCharacter id="lord_1_2" name="{=lord_1_2.name}Ragneda" voice="earnest" age="23" is_female="true" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_1_7']">
        <NPCCharacter id="lord_1_7" name="{=lord_1_7.name}Auctume" voice="ironic" age="31" is_female="false" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
    ...
    <xsl:template match="NPCCharacter[@id='lord_1_8']">
        <NPCCharacter id="lord_1_8" name="{=lord_1_8.name}Ginta" voice="softspoken" age="23" is_female="true" is_hero="true" culture="Culture.baltic" occupation="Lord" default_group="Cavalry">
            <face>
                <!-- custom face -->
