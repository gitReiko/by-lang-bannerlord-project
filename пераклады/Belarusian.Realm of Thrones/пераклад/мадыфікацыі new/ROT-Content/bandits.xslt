...
<xsl:template match="@*|node()">
	...
	<xsl:template match="NPCCharacter[@id='sea_raiders_bandit']">
		<NPCCharacter id="sea_raiders_bandit" default_group="Infantry" name="{{=ROTfba2dca81}}Pirate" level="11" occupation="Bandit" culture="Culture.sea_raiders">
    <face>
      ...
      <upgrade_target id="NPCCharacter.sea_raiders_raider"/>
			...
			<Equipments>
				...
				<EquipmentRoster>
					...
					<equipment slot="Body" id="Item.crude_armor"/>
					<equipment slot="Head" id="Item.crude_helmet"/>
					<equipment slot="Leg" id="Item.crude_boots"/>
				</EquipmentRoster>
...
<xsl:template match="NPCCharacter[@id='sea_raiders_raider']">
	<NPCCharacter id="sea_raiders_raider" default_group="Infantry" name="{{=ROT7591a074b}}Ravager" level="16" occupation="Bandit" culture="Culture.sea_raiders">
    <face>
      <face_key_template value="BodyProperty.villager_sturgia"/>
    </face>
    <skills>
      ...
      <upgrade_target id="NPCCharacter.sea_raiders_chief"/>
		...
		<Equipments>
			...
			<EquipmentRoster>
				...
				<equipment slot="Body" id="Item.crude_armor"/>
				<equipment slot="Head" id="Item.crude_barbute"/>
				<equipment slot="Leg" id="Item.crude_boots"/>
			</EquipmentRoster>
...
<xsl:template match="NPCCharacter[@id='sea_raiders_chief']">
	<NPCCharacter id="sea_raiders_chief" default_group="Infantry" name="{{=ROT8b6f3e9d3}}Reaver" level="21" occupation="Bandit" culture="Culture.sea_raiders">
    <face>
      <face_key_template value="BodyProperty.villager_sturgia"/>
    </face>
    <skills>
    ...
    <upgrade_targets>
		...
		<Equipments>
			...
			<EquipmentRoster>
				...
				<equipment slot="Item2" id="Item.northern_javelin_1_t2"/>
				<equipment slot="Body" id="Item.crude_armor"/>
				<equipment slot="Head" id="Item.crude_nasal"/>
				<equipment slot="Leg" id="Item.crude_boots"/>
				<equipment slot="Cape" id="Item.crude_pauldrons"/>
			</EquipmentRoster>
...
<xsl:template match="NPCCharacter[@id='sea_raiders_boss']">
	<NPCCharacter id="sea_raiders_boss" default_group="Infantry" name="{{=ROT832dfb8e2}}Marauder" level="26" occupation="Bandit" culture="Culture.sea_raiders">
    <face>
      <face_key_template value="BodyProperty.villager_sturgia"/>
    </face>
    <skills>
    ...
    <upgrade_targets/>
		<Equipments>
			...
			<EquipmentRoster>
				...
				<equipment slot="Body" id="Item.crude_armor"/>
				<equipment slot="Head" id="Item.crude_spangen"/>
				<equipment slot="Leg" id="Item.crude_boots"/>
				<equipment slot="Cape" id="Item.crude_pauldrons"/>
...
<xsl:template match="NPCCharacter[@id='looter']">
	<NPCCharacter id="looter" default_group="Infantry" name="{{=ROTda04bc888}}Broken Man" level="6" occupation="Bandit" culture="Culture.looters">
    <face>
...
<xsl:template match="NPCCharacter[@id='steppe_bandits_bandit']">
	<NPCCharacter id="steppe_bandits_bandit" default_group="Cavalry" name="{{=ROT89dae47dd}}Rogue Dothraki" level="11" occupation="Bandit" culture="Culture.steppe_bandits">
    <face>
    ...
    <Equipments>
      ...
      <EquipmentRoster>
        <equipment slot="Item0" id="Item.khuzait_sword_3_t3"/>
		  <equipment slot="Item1" id="Item.steppe_bow"/>
		  <equipment slot="Item2" id="Item.steppe_arrows"/>
        <equipment slot="Body" id="Item.dothraki_armor8"/>
...
<xsl:template match="NPCCharacter[@id='steppe_bandits_raider']">
	<NPCCharacter id="steppe_bandits_raider" default_group="HorseArcher" name="{{=ROT6db9ac4de}}Dothraki Pillager" level="16" occupation="Bandit" culture="Culture.steppe_bandits">
    <face>
      <face_key_template value="BodyProperty.fighter_dothraki"/>
    </face>
    <skills>
    ...
    <Equipments>
      <EquipmentRoster civilian="true">
        ...
        <equipment slot="Body" id="Item.dothraki_armor8"/>
        <equipment slot="Leg" id="Item.dothraki_boots"/>
        <equipment slot="Horse" id="Item.khuzait_horse"/>
      ...
      <EquipmentRoster>
        ...
        <equipment slot="Item2" id="Item.steppe_arrows"/>
        <equipment slot="Item3" id="Item.arakh"/>
        <equipment slot="Body" id="Item.dothraki_armor"/>
        <equipment slot="Leg" id="Item.dothraki_boots"/>
        <equipment slot="Gloves" id="Item.dothraki_bracers"/>
	  <equipment slot="Horse" id="Item.khuzait_horse"/>
...
<xsl:template match="NPCCharacter[@id='steppe_bandits_chief']">
	<NPCCharacter id="steppe_bandits_chief" default_group="HorseArcher" name="{{=ROTfbeba7acb}}Dothraki Ambusher" level="21" occupation="Bandit" culture="Culture.steppe_bandits">
    <face>
      <face_key_template value="BodyProperty.fighter_dothraki"/>
    </face>
    <skills>
    ...
    <Equipments>
      <EquipmentRoster civilian="true">
        ...
        <equipment slot="Item3" id="Item.default_arrows"/>
        <equipment slot="Head" id="Item.dothraki_hair"/>
        <equipment slot="Body" id="Item.dothraki_armor2"/>
        <equipment slot="Leg" id="Item.dothraki_boots"/>
        <equipment slot="Cape" id="Item.dothraki_shoulders2"/>
        <equipment slot="Gloves" id="Item.dothraki_bracers"/>
      ...
      <EquipmentRoster>
        ...
        <equipment slot="Item2" id="Item.steppe_arrows"/>
		  ...
		  <equipment slot="Leg" id="Item.dothraki_boots"/>
		  <equipment slot="Gloves" id="Item.dothraki_bracers"/>
		  <equipment slot="Cape" id="Item.dothraki_shoulders"/>
	  <equipment slot="Horse" id="Item.khuzait_horse"/>
      <equipment slot="HorseHarness" id="Item.steppe_fur_harness"/>
      </EquipmentRoster>
...
<xsl:template match="NPCCharacter[@id='steppe_bandits_boss']">
	<NPCCharacter id="steppe_bandits_boss" default_group="HorseArcher" name="{{=ROTc800cd02e}}Steppe Bandit Boss" level="26" occupation="Bandit" culture="Culture.steppe_bandits">
    <face>
      <face_key_template value="BodyProperty.fighter_dothraki"/>
    </face>
    <skills>
...
<xsl:template match="NPCCharacter[@id='mountain_bandits_bandit']">
	<NPCCharacter id="mountain_bandits_bandit" default_group="Infantry" name="{{=ROTcb067a1a0}}Hillman" level="11" occupation="Bandit" culture="Culture.mountain_bandits">
		<face>
...
<xsl:template match="NPCCharacter[@id='mountain_bandits_raider']">
	<NPCCharacter id="mountain_bandits_raider" default_group="Infantry" name="{{=ROTab0df57b0}}Brigand" level="16" occupation="Bandit" culture="Culture.mountain_bandits">
		<face>
			<face_key_template value="BodyProperty.villager_battania"/>
		</face>
		<skills>
		...
		<Equipments>
			<EquipmentRoster civilian="true">
				<equipment slot="Item0" id="Item.western_spear_4_t3"/>
			...
			<EquipmentRoster>
				<equipment slot="Item0" id="Item.vlandia_axe_1_t3"/>
				<equipment slot="Item1" id="Item.old_kite_shield"/>
				<equipment slot="Item2" id="Item.western_spear_4_t3"/>
				<equipment slot="Item3" id="Item.western_javelin_2_t3"/>
				<equipment slot="Head" id="Item.wrapped_headcloth"/>
...
<xsl:template match="NPCCharacter[@id='mountain_bandits_chief']">
	<NPCCharacter id="mountain_bandits_chief" default_group="Cavalry" name="{{=ROTb67639d5f}}Highwayman" level="21" upgrade_requires="ItemCategory.horse" occupation="Bandit" culture="Culture.mountain_bandits">
		<face>
			<face_key_template value="BodyProperty.villager_battania"/>
		</face>
		<skills>
		...
		<Equipments>
			...
			<EquipmentRoster>
				<equipment slot="Item2" id="Item.western_spear_5_t4"/>
				<equipment slot="Item1" id="Item.old_kite_shield"/>
...
<xsl:template match="NPCCharacter[@id='forest_bandits_bandit']">
	<NPCCharacter id="forest_bandits_bandit" default_group="Ranged" name="{{=ROT5cfe6a648}}Bushwacker" level="11" occupation="Bandit" culture="Culture.forest_bandits">
		<face>
...
<xsl:template match="NPCCharacter[@id='forest_bandits_raider']">
	<NPCCharacter id="forest_bandits_raider" default_group="Ranged" name="{{=ROTe5ea6208a}}Freebooter" level="16" occupation="Bandit" culture="Culture.forest_bandits">
		<face>
			<face_key_template value="BodyProperty.villager_vlandia"/>
		</face>
		<skills>
...
<xsl:template match="NPCCharacter[@id='forest_bandits_chief']">
	<NPCCharacter id="forest_bandits_chief" default_group="Ranged" name="{{=ROT7dbc21956}}Forest Bandit" level="21" occupation="Bandit" culture="Culture.forest_bandits">
		<face>
			<face_key_template value="BodyProperty.villager_vlandia"/>
		</face>
		<skills>
...
<xsl:template match="NPCCharacter[@id='mountain_bandits_boss']">
	<NPCCharacter id="mountain_bandits_boss" default_group="Infantry" name="{{=ROTdb330aca3}}Mountain Bandit Boss" level="26" occupation="Bandit" culture="Culture.mountain_bandits">
		<face>
			<face_key_template value="BodyProperty.villager_battania"/>
		</face>
		<skills>
...
<xsl:template match="NPCCharacter[@id='forest_bandits_boss']">
	<NPCCharacter id="forest_bandits_boss" default_group="Ranged" name="{{=ROT77fa3d904}}Forest Bandit Boss" level="26" occupation="Bandit" culture="Culture.forest_bandits">
		<face>
			<face_key_template value="BodyProperty.villager_vlandia"/>
		</face>
		<skills>
