...
<xsl:template match="NPCCharacter[@id='mountain_bandits_bandit']">
	<NPCCharacter
		...
		<face>
			<face_key_template
				value="BodyProperty.villager_battania" />
		</face>
		<skills>
			<skill
				id="Athletics"
		...
		<upgrade_targets>
			<upgrade_target
				id="NPCCharacter.mountain_bandits_raider" />
			<upgrade_target
				id="NPCCharacter.vlandian_infantry" />
		</upgrade_targets>
		<Equipments>
			<EquipmentRoster
				civilian="true">
			...
			<EquipmentRoster>
				...
				<equipment
					slot="Body"
					id="Item.sleeveless_studded_fur_armor" />
				<equipment
					slot="Leg"
					id="Item.wrapped_shoes" />
			</EquipmentRoster>
...
<xsl:template match="NPCCharacter[@id='mountain_bandits_raider']">
	<NPCCharacter
		...
		<upgrade_targets>
			<upgrade_target
				id="NPCCharacter.vlandian_billman" />
			<upgrade_target
				id="NPCCharacter.mountain_bandits_chief" />
		</upgrade_targets>
		<Equipments>
			<EquipmentRoster
				civilian="true">
				<equipment
					slot="Item0"
					id="Item.western_spear_4_t3" />
				<equipment
					slot="Item1"
					id="Item.old_kite_shield" />
				<equipment
					slot="Item2"
					id="Item.vlandia_axe_1_t3" />
				<equipment
					slot="Item3"
					id="Item.western_javelin_2_t3" />
				<equipment
					slot="Head"
					id="Item.wrapped_headcloth" />
				<equipment
					slot="Body"
					id="Item.patched_gambeson" />
				<equipment
					slot="Leg"
...
<xsl:template match="NPCCharacter[@id='mountain_bandits_chief']">
	<NPCCharacter
		...
		<upgrade_targets>
			<upgrade_target
				id="NPCCharacter.vlandian_champion" />
		</upgrade_targets>
		<Equipments>
			<EquipmentRoster
				civilian="true">
			...
			<EquipmentRoster>
				...
				<equipment
					slot="Head"
					id="Item.leather_studdedhelm_over_thinhide" />
				<equipment
					slot="Body"
				...
				<equipment
					slot="Gloves"
					id="Item.reinforced_padded_mitten" />
				<equipment
					slot="Cape"
			...
			<EquipmentRoster>
				...
				<equipment
					slot="Head"
					id="Item.leather_studdedhelm_over_headcloth" />
				<equipment
					slot="Gloves"
					id="Item.mail_mitten" />
				<equipment
...
<xsl:template match="NPCCharacter[@id='forest_bandits_bandit']">
	<NPCCharacter
		...
		<face>
			<face_key_template
				value="BodyProperty.villager_vlandia" />
		</face>
		<skills>
			<skill
				id="Athletics"
		...
		<upgrade_targets>
			<upgrade_target
				id="NPCCharacter.forest_bandits_raider" />
			<upgrade_target
				id="NPCCharacter.battanian_raider" />
		</upgrade_targets>
		<Equipments>
			<EquipmentRoster
				civilian="true">
			...
			<EquipmentRoster>
				<equipment
					slot="Item0"
					id="Item.mountain_hunting_bow" />
				<equipment
					slot="Item1"
					id="Item.default_arrows" />
				<equipment
					slot="Item2"
					id="Item.simple_back_sword_t2" />
				<equipment
					slot="Item3"
					id="Item.default_arrows" />
				<equipment
...
<xsl:template match="NPCCharacter[@id='forest_bandits_raider']">
	<NPCCharacter
		...
		<upgrade_targets>
			<upgrade_target
				id="NPCCharacter.forest_bandits_chief" />
			<upgrade_target
				id="NPCCharacter.battanian_falxman" />
		</upgrade_targets>
		<Equipments>
			<EquipmentRoster
				civilian="true">
...
<xsl:template match="NPCCharacter[@id='forest_bandits_chief']">
	<NPCCharacter
		...
		<upgrade_targets>
			<upgrade_target
				id="NPCCharacter.battanian_fian" />
		</upgrade_targets>
		<Equipments>
			<EquipmentRoster
				civilian="true">
			...
			<EquipmentRoster>
				...
				<equipment
					slot="Item2"
					id="Item.battania_axe_2_t4" />
				<equipment
					slot="Item3"
					id="Item.barbed_arrows" />
				<equipment
					slot="Body"
					id="Item.rough_fur_over_chain" />
				<equipment
					slot="Leg"
					id="Item.battania_woodland_boots" />
				<equipment
					slot="Gloves"
					id="Item.woven_leather_bracers" />
				<equipment
					slot="Head"
					id="Item.wolfhead" />
				<equipment
					slot="Cape"
					id="Item.wolf_shoulder" />
			</EquipmentRoster>
			<EquipmentRoster>
				<equipment
					slot="Item0"
			...
			<EquipmentRoster>
				...
				<equipment
					slot="Body"
					id="Item.battania_mercenary_armor" />
				<equipment
					slot="Leg"
					id="Item.mail_chausses" />
				<equipment
...
<xsl:template match="NPCCharacter[@id='mountain_bandits_boss']">
	<NPCCharacter
		id="mountain_bandits_boss"
		default_group="Infantry"
		name="Mountain Bandit Boss"
		level="26"
		occupation="Bandit"
		culture="Culture.mountain_bandits">
		<face>
		...
		<Equipments>
			...
			<EquipmentRoster>
				...
				<equipment
					slot="Body"
					id="Item.veteran_mercenary_armor" />
				<equipment
					slot="Leg"
					id="Item.rough_tied_boots" />
				<equipment
...
<xsl:template match="NPCCharacter[@id='forest_bandits_boss']">
	<NPCCharacter
		id="forest_bandits_boss"
		default_group="Ranged"
		name="Forest Bandit Boss"
		level="26"
		occupation="Bandit"
		culture="Culture.forest_bandits">
		<face>
