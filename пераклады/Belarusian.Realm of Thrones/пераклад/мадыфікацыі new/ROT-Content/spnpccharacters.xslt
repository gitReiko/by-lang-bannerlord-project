...
<xsl:template match="@*|node()">
	...
	<xsl:template match="NPCCharacter[@id='caravan_master_battania']">
		<NPCCharacter id="caravan_master_battania" default_group="Infantry" level="26" name="{{=ROT794e8a39f}}First Men Caravan Master" occupation="CaravanGuard" culture="Culture.battania">
		<face>
		...
		<Equipments>
			<EquipmentRoster>
				<equipment slot="Item0" id="Item.vlandia_pike_1_t5"/>
				<equipment slot="Item1" id="Item.stark_sword"/>
				<equipment slot="Item2" id="Item.heavy_heater_shield"/>
				<equipment slot="Head" id="Item.northern_helmet2"/>
				<equipment slot="Body" id="Item.stark_armor_1"/>
				<equipment slot="Cape" id="Item.karstark_gorget"/>
				<equipment slot="Leg" id="Item.stark_boots_1"/>
			<equipment slot="Gloves" id="Item.kg_gloves"/>
			</EquipmentRoster>
			<EquipmentRoster civilian="true">
        <equipment slot="Item0" id="Item.battania_sword_2_t3"/>
...
<xsl:template match="NPCCharacter[@id='armed_trader_battania']">
		<NPCCharacter id="armed_trader_battania" default_group="Ranged" level="16" name="{{=ROT596d2e147}}First Men Armed Trader" occupation="CaravanGuard" culture="Culture.battania" is_basic_troop="true">
		<face>
			<face_key_template value="BodyProperty.fighter_battania"/>
		</face>
		<skills>
		...
		<Equipments>
			<EquipmentRoster>
				...
				<equipment slot="Body" id="Item.north_gambeson"/>
				<equipment slot="Leg" id="Item.jon_snow_boots"/>
...
<xsl:template match="NPCCharacter[@id='caravan_guard_battania']">
		<NPCCharacter id="caravan_guard_battania" default_group="Cavalry" level="21" name="{{=ROT592b02b04}}First Men Caravan Guard" upgrade_requires="ItemCategory.horse" occupation="CaravanGuard" culture="Culture.battania">
		<face>
			<face_key_template value="BodyProperty.fighter_battania"/>
		</face>
		<skills>
		...
		<Equipments>
			<EquipmentRoster>
				<equipment slot="Item0" id="Item.highland_throwing_axe_1_t2"/>
				<equipment slot="Item1" id="Item.northern_spear_2_t3"/>
				<equipment slot="Item2" id="Item.woodland_axe_t3"/>
				<equipment slot="Item3" id="Item.bound_horsemans_kite_shield"/>
				<equipment slot="Head" id="Item.northern_helmet2"/>
				<equipment slot="Body" id="Item.north_gambeson"/>
				<equipment slot="Leg" id="Item.jon_snow_boots"/>
        ...
        <equipment slot="Item1" id="Item.northern_spear_2_t3"/>
        <equipment slot="Item2" id="Item.woodland_axe_t3"/>
        <equipment slot="Item3" id="Item.battania_targe_b"/>
        <equipment slot="Head" id="Item.battania_fur_helmet"/>
...
<xsl:template match="NPCCharacter[@id='veteran_caravan_guard_battania']">
		<NPCCharacter id="veteran_caravan_guard_battania" default_group="Cavalry" level="26" name="{{=ROTf5d97eabe}}First Men Veteran Caravan Guard" upgrade_requires="ItemCategory.war_horse" occupation="CaravanGuard" culture="Culture.battania">
		<face>
			<face_key_template value="BodyProperty.fighter_battania"/>
		</face>
		<skills>
		...
		<Equipments>
			<EquipmentRoster>
				...
				<equipment slot="Item2" id="Item.stark_sword"/>
				<equipment slot="Item3" id="Item.reinforced_horsemans_kite_shield"/>
				<equipment slot="Head" id="Item.northern_helmet2"/>
				<equipment slot="Body" id="Item.stark_armor_1"/>
				<equipment slot="Cape" id="Item.karstark_gorget"/>
				<equipment slot="Leg" id="Item.stark_boots_1"/>
        ...
        <equipment slot="Item3" id="Item.battania_shield_targe_a"/>
        <equipment slot="Head" id="Item.ridged_northernhelm"/>
        <equipment slot="Body" id="Item.battania_woodland_chainmail"/>
	...
	<xsl:template match="NPCCharacter[@id='caravan_master_vlandia']">
		<NPCCharacter id="caravan_master_vlandia" default_group="Infantry" level="26" name="{{=ROT87da891cf}}Andal Caravan Master" occupation="CaravanGuard" culture="Culture.vlandia">
			<face>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Head" id="Item.reach_helmet2"/>
					<equipment slot="Body" id="Item.brigandine2"/>
					<equipment slot="Leg" id="Item.jon_snow_boots"/>
					<equipment slot="Cape" id="Item.stormlands_shoulders2"/>
				</EquipmentRoster>
				<EquipmentRoster civilian="true">
        <equipment slot="Item0" id="Item.vlandia_sword_2_t3"/>
        <equipment slot="Head" id="Item.pointed_skullcap_over_laced_coif"/>
	...
	<xsl:template match="NPCCharacter[@id='armed_trader_vlandia']">
		<NPCCharacter id="armed_trader_vlandia" default_group="Ranged" level="16" name="{{=ROTd763e8a9e}}Andal Armed Trader" occupation="CaravanGuard" culture="Culture.vlandia" is_basic_troop="true">
			<face>
				<face_key_template value="BodyProperty.fighter_vlandia"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Body" id="Item.riverlands_gambeson"/>
	...
	<xsl:template match="NPCCharacter[@id='caravan_guard_vlandia']">
		<NPCCharacter id="caravan_guard_vlandia" default_group="Cavalry" level="21" name="{{=ROTce77feca5}}Andal Caravan Guard" upgrade_requires="ItemCategory.horse" occupation="CaravanGuard" culture="Culture.vlandia">
			<face>
				<face_key_template value="BodyProperty.fighter_vlandia"/>
			</face>
			<skills>
	...
	<xsl:template match="NPCCharacter[@id='veteran_caravan_guard_vlandia']">
		<NPCCharacter id="veteran_caravan_guard_vlandia" default_group="Cavalry" level="26" name="{{=ROT3db1d8c8a}}Andal Veteran Caravan Guard" upgrade_requires="ItemCategory.war_horse" occupation="CaravanGuard" culture="Culture.vlandia">
			<face>
				<face_key_template value="BodyProperty.fighter_vlandia"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Item2" id="Item.western_riders_kite_shield"/>
					<equipment slot="Head" id="Item.reach_helmet2"/>
					<equipment slot="Body" id="Item.brigandine2"/>
					<equipment slot="Leg" id="Item.jon_snow_boots"/>
        ...
        <equipment slot="Item1" id="Item.vlandia_axe_2_t4"/>
        <equipment slot="Item2" id="Item.western_riders_kite_shield"/>
	...
	<xsl:template match="NPCCharacter[@id='caravan_master_aserai']">
		<NPCCharacter id="caravan_master_aserai" default_group="Infantry" level="26" name="{{=ROT600b61ae7}}Rhoynar Caravan Master" occupation="CaravanGuard" culture="Culture.aserai">
			<face>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Item2" id="Item.desert_round_shield"/>
					<equipment slot="Head" id="Item.dorne_plate_helmet"/>
					<equipment slot="Body" id="Item.dorne_plate"/>
					<equipment slot="Gloves" id="Item.dorne_bracers"/>
	...
	<xsl:template match="NPCCharacter[@id='armed_trader_aserai']">
		<NPCCharacter id="armed_trader_aserai" default_group="Ranged" level="16" name="{{=ROT7e060a1dd}}Rhoynar Armed Trader" occupation="CaravanGuard" culture="Culture.aserai" is_basic_troop="true">
			<face>
				<face_key_template value="BodyProperty.fighter_aserai"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Item1" id="Item.bodkin_arrows_b"/>
					<equipment slot="Item2" id="Item.aserai_sword_2_t2"/>
					<equipment slot="Body" id="Item.stormlands_gambeson"/>
					<equipment slot="Leg" id="Item.khuzait_curved_boots"/>
				</EquipmentRoster>
				<EquipmentRoster civilian="true">
	...
	<xsl:template match="NPCCharacter[@id='caravan_guard_aserai']">
		<NPCCharacter id="caravan_guard_aserai" default_group="Cavalry" level="21" name="{{=ROT511b65226}}Rhoynar Caravan Guard" upgrade_requires="ItemCategory.horse" occupation="CaravanGuard" culture="Culture.aserai">
			<face>
				<face_key_template value="BodyProperty.fighter_aserai"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.southern_spear_3_t3"/>
					<equipment slot="Item1" id="Item.aserai_sword_3_t3"/>
				...
				<EquipmentRoster civilian="true">
					...
					<equipment slot="Item1" id="Item.aserai_sword_3_t3"/>
					<equipment slot="Item2" id="Item.bound_adarga"/>
	...
	<xsl:template match="NPCCharacter[@id='veteran_caravan_guard_aserai']">
		<NPCCharacter id="veteran_caravan_guard_aserai" default_group="HorseArcher" level="26" name="{{=ROT9322214fb}}Rhoynar Veteran Caravan Guard" upgrade_requires="ItemCategory.war_horse" occupation="CaravanGuard" culture="Culture.aserai">
			<face>
				<face_key_template value="BodyProperty.fighter_aserai"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Item1" id="Item.bodkin_arrows_b"/>
					<equipment slot="Item2" id="Item.aserai_sword_6_t4"/>
				...
				<EquipmentRoster civilian="true">
					...
					<equipment slot="Item2" id="Item.aserai_sword_5_t4"/>
					<equipment slot="Item3" id="Item.bound_desert_round_shield"/>
				...
				<EquipmentRoster civilian="true">
					...
					<equipment slot="Item1" id="Item.default_arrows"/>
					<equipment slot="Item2" id="Item.aserai_sword_5_t4"/>
					<equipment slot="Item3" id="Item.large_adarga"/>
	...
	<xsl:template match="NPCCharacter[@id='caravan_master_khuzait']">
		<NPCCharacter id="caravan_master_khuzait" default_group="Infantry" level="26" name="{{=ROT2c2611073}}Grass Sea Caravan Master" occupation="CaravanGuard" culture="Culture.khuzait">
			<face>
			...
			<Equipments>
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.khuzait_sword_3_t3"/>
	...
	<xsl:template match="NPCCharacter[@id='armed_trader_khuzait']">
		<NPCCharacter id="armed_trader_khuzait" default_group="Ranged" level="16" name="{{=ROT9c49d4a3f}}Grass Sea Armed Trader" occupation="CaravanGuard" culture="Culture.khuzait" is_basic_troop="true">
			<face>
				<face_key_template value="BodyProperty.fighter_khuzait"/>
			</face>
			<skills>
	...
	<xsl:template match="NPCCharacter[@id='caravan_guard_khuzait']">
		<NPCCharacter id="caravan_guard_khuzait" default_group="Cavalry" level="21" name="{{=ROTf68b93cbc}}Grass Sea Caravan Guard" upgrade_requires="ItemCategory.horse" occupation="CaravanGuard" culture="Culture.khuzait">
			<face>
				<face_key_template value="BodyProperty.fighter_khuzait"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.eastern_spear_3_t3"/>
					<equipment slot="Item1" id="Item.khuzait_sword_3_t3"/>
					<equipment slot="Item2" id="Item.worn_horsemans_kite_shield"/>
				...
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.eastern_spear_3_t3"/>
					<equipment slot="Item1" id="Item.khuzait_sword_2_t3"/>
					<equipment slot="Item2" id="Item.worn_horsemans_kite_shield"/>
	...
	<xsl:template match="NPCCharacter[@id='veteran_caravan_guard_khuzait']">
		<NPCCharacter id="veteran_caravan_guard_khuzait" default_group="HorseArcher" level="26" name="{{=ROT7ace127ce}}Grass Sea Veteran Caravan Guard" occupation="CaravanGuard" culture="Culture.khuzait">
			<face>
				<face_key_template value="BodyProperty.fighter_khuzait"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Item1" id="Item.default_arrows"/>
					<equipment slot="Item2" id="Item.khuzait_mace_3_t4"/>
				...
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.steppe_heavy_bow"/>
					<equipment slot="Item1" id="Item.default_arrows"/>
					<equipment slot="Item2" id="Item.khuzait_mace_2_t4"/>
					<equipment slot="Item3" id="Item.decorated_steppe_shield"/>
					<equipment slot="Head" id="Item.plumed_fur_lined_helmet"/>
					<equipment slot="Body" id="Item.eastern_plated_leather"/>
					<equipment slot="Leg" id="Item.khuzait_curved_boots"/>
	...
	<xsl:template match="NPCCharacter[@id='caravan_master_empire']">
		<NPCCharacter id="caravan_master_empire" default_group="Infantry" level="26" name="{{=ROTbb9f118ff}}Essosi Caravan Master" occupation="CaravanGuard" culture="Culture.empire">
			<face>
	...
	<xsl:template match="NPCCharacter[@id='armed_trader_empire']">
		<NPCCharacter id="armed_trader_empire" default_group="Ranged" level="16" name="{{=ROT8e4fa8892}}Essosi Armed Trader" occupation="CaravanGuard" culture="Culture.empire" is_basic_troop="true">
			<face>
				<face_key_template value="BodyProperty.fighter_empire"/>
			</face>
			<skills>
			...
			<Equipments>
				...
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.glen_ranger_bow"/>
					<equipment slot="Item1" id="Item.range_arrows"/>
					<equipment slot="Item2" id="Item.battania_mace_1_t2"/>
	...
	<xsl:template match="NPCCharacter[@id='caravan_guard_empire']">
		<NPCCharacter id="caravan_guard_empire" default_group="HorseArcher" level="21" name="{{=ROT8c9160c3f}}Essosi Caravan Guard" upgrade_requires="ItemCategory.horse" occupation="CaravanGuard" culture="Culture.empire">
			<face>
				<face_key_template value="BodyProperty.fighter_empire"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Item2" id="Item.crossbow_e"/>
					<equipment slot="Item3" id="Item.bolt_b"/>
	...
	<xsl:template match="NPCCharacter[@id='veteran_caravan_guard_empire']">
		<NPCCharacter id="veteran_caravan_guard_empire" default_group="Cavalry" level="26" name="{{=ROTf2c2df309}}Essosi Veteran Caravan Guard" occupation="CaravanGuard" culture="Culture.empire">
			<face>
				<face_key_template value="BodyProperty.fighter_empire"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.western_spear_4_t4"/>
					<equipment slot="Item1" id="Item.empire_sword_5_t4"/>
					<equipment slot="Item2" id="Item.bound_horsemans_kite_shield"/>
					<equipment slot="Head" id="Item.imperial_mail_coif"/>
					<equipment slot="Body" id="Item.legionary_mail"/>
					<equipment slot="Leg" id="Item.leather_shoes"/>
					<equipment slot="Gloves" id="Item.leather_gloves"/>
	...
	<xsl:template match="NPCCharacter[@id='caravan_master_sturgia']">
		<NPCCharacter id="caravan_master_sturgia" default_group="Infantry" level="26" name="{{=ROT6c14a39e5}}Ironborn Caravan Master" occupation="CaravanGuard" culture="Culture.sturgia">
			<face>
	...
	<xsl:template match="NPCCharacter[@id='armed_trader_sturgia']">
		<NPCCharacter id="armed_trader_sturgia" default_group="Ranged" level="16" name="{{=ROTc9b52ede7}}Ironborn Armed Trader" occupation="CaravanGuard" culture="Culture.sturgia" is_basic_troop="true">
			<face>
				<face_key_template value="BodyProperty.fighter_sturgia"/>
			</face>
			<skills>
	...
	<xsl:template match="NPCCharacter[@id='caravan_guard_sturgia']">
		<NPCCharacter id="caravan_guard_sturgia" default_group="Cavalry" level="21" name="{{=ROT7e807c0e2}}Ironborn Caravan Guard" upgrade_requires="ItemCategory.horse" occupation="CaravanGuard" culture="Culture.sturgia">
			<face>
				<face_key_template value="BodyProperty.fighter_sturgia"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					...
					<equipment slot="Item1" id="Item.battania_mace_1_t2"/>
					<equipment slot="Item2" id="Item.northern_scouts_shield"/>
				...
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.northern_spear_1_t2"/>
					<equipment slot="Item1" id="Item.battania_mace_2_t2"/>
					<equipment slot="Item2" id="Item.northern_scouts_shield"/>
					<equipment slot="Head" id="Item.northern_fur_cap"/>
	...
	<xsl:template match="NPCCharacter[@id='veteran_caravan_guard_sturgia']">
		<NPCCharacter id="veteran_caravan_guard_sturgia" default_group="Cavalry" level="26" name="{{=ROT8296b2648}}Ironborn Veteran Caravan Guard" occupation="CaravanGuard" culture="Culture.sturgia">
			<face>
				<face_key_template value="BodyProperty.fighter_sturgia"/>
			</face>
			<skills>
			...
			<Equipments>
				<EquipmentRoster>
					<equipment slot="Item0" id="Item.northern_javelin_3_t4"/>
					<equipment slot="Item1" id="Item.northern_spear_2_t3"/>
					<equipment slot="Item2" id="Item.light_mace_t3"/>
					<equipment slot="Item3" id="Item.northern_horsemans_shield"/>
