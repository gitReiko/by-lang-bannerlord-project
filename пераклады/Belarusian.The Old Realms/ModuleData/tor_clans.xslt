<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="Item[@id='averland_clan_2']/@name">
        <xsl:attribute name="name">{=averland_clan_2.name}Alptraum</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='averland_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='averland_clan_3']/@name">
        <xsl:attribute name="name">{=averland_clan_3.name}The Averland Treatise</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='averland_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='averland_clan_4']/@name">
        <xsl:attribute name="name">{=averland_clan_4.name}Knights of the Blazing Sun</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='averland_clan_4']/@text">
    ...
    <xsl:template match="Item[@id='averland_clan_5']/@name">
        <xsl:attribute name="name">{=averland_clan_5.name}The Golden Order</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='averland_clan_5']/@text">
    ...
    <xsl:template match="Item[@id='sylvania_clan_1']/@name">
        <xsl:attribute name="name">{=sylvania_clan_1.name}The Von Carsteins</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='sylvania_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='sylvania_clan_2']/@name">
        <xsl:attribute name="name">{=sylvania_clan_2.name}Nightmarish Pedigree</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='sylvania_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='sylvania_clan_4']/@name">
        <xsl:attribute name="name">{=sylvania_clan_4.name}The Scarlet Order</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='sylvania_clan_4']/@text">
    ...
    <xsl:template match="Item[@id='sylvania_clan_3']/@name">
        <xsl:attribute name="name">{=sylvania_clan_3.name}Traitor's Blood</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='sylvania_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='blooddragons_clan_1']/@name">
        <xsl:attribute name="name">{=blooddragons_clan_1.name}Order of the Blood Dragon</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='blooddragons_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='necrarch_clan_1']/@name">
        <xsl:attribute name="name">{=necrarch_clan_1.name}The Tower of Shadows</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='necrarch_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='necrarch_clan_2']/@name">
        <xsl:attribute name="name">{=necrarch_clan_2.name}Remains of the Madhouse of Lembrook</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='necrarch_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='stirland_clan_1']/@name">
        <xsl:attribute name="name">{=stirland_clan_1.name}Haupt-Anderssen</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='stirland_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='stirland_clan_2']/@name">
        <xsl:attribute name="name">{=stirland_clan_2.name}Men of Morr</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='stirland_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='stirland_clan_3']/@name">
        <xsl:attribute name="name">{=stirland_clan_3.name}Southern Stirland</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='stirland_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='stirland_clan_4']/@name">
        <xsl:attribute name="name">{=stirland_clan_4.name}Cult of Sigmar</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='stirland_clan_4']/@text">
    ...
    <xsl:template match="Item[@id='wissenland_clan_1']/@name">
        <xsl:attribute name="name">{=wissenland_clan_1.name}von Liebwitz</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='wissenland_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='wissenland_clan_2']/@name">
        <xsl:attribute name="name">{=wissenland_clan_2.name}Toppenheimer</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='wissenland_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='wissenland_clan_3']/@name">
        <xsl:attribute name="name">{=wissenland_clan_3.name}Sollander</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='wissenland_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='talabecland_clan_1']/@name">
        <xsl:attribute name="name">{=talabecland_clan_1.name}Taal's Chosen</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='talabecland_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='talabecland_clan_2']/@name">
        <xsl:attribute name="name">{=talabecland_clan_2.name}Grenzwacht</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='talabecland_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='talabecland_clan_3']/@name">
        <xsl:attribute name="name">{=talabecland_clan_3.name}Rindenhaut</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='talabecland_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='reikland_clan_1']/@name">
        <xsl:attribute name="name">{=reikland_clan_1.name}von Holswig-Schliestein</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='reikland_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='middenland_clan_2']/@name">
        <xsl:attribute name="name">{=middenland_clan_2.name}von Bildhofen</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='middenland_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='middenland_clan_3']/@name">
        <xsl:attribute name="name">{=middenland_clan_3.name}Drakwald Guard</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='middenland_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='ostermark_clan_1']/@name">
        <xsl:attribute name="name">{=ostermark_clan_1.name}Hertwig</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='ostermark_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='ostermark_clan_2']/@name">
        <xsl:attribute name="name">{=ostermark_clan_2.name}Schweissbrau</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='ostermark_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='ostermark_clan_3']/@name">
        <xsl:attribute name="name">{=ostermark_clan_3.name}Siebentod</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='ostermark_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='hochland_clan_1']/@name">
        <xsl:attribute name="name">{=hochland_clan_1.name}von Ludendorf</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='hochland_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='hochland_clan_2']/@name">
        <xsl:attribute name="name">{=hochland_clan_2.name}von Halberwald</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='hochland_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='hochland_clan_3']/@name">
        <xsl:attribute name="name">{=hochland_clan_3.name}von Hohenstein</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='hochland_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='ostland_clan_2']/@name">
        <xsl:attribute name="name">{=ostland_clan_2.name}von Strudt</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='ostland_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='ostland_clan_3']/@name">
        <xsl:attribute name="name">{=ostland_clan_3.name}Lords of the Northern March</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='ostland_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='ostland_clan_4']/@name">
        <xsl:attribute name="name">{=ostland_clan_4.name}League of North Talabec</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='ostland_clan_4']/@text">
    ...
    <xsl:template match="Item[@id='wasteland_clan_2']/@name">
        <xsl:attribute name="name">{=wasteland_clan_2.name}Cult of Manaan</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='wasteland_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='wasteland_clan_3']/@name">
        <xsl:attribute name="name">{=wasteland_clan_3.name}den Euwe</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='wasteland_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='wasteland_clan_4']/@name">
        <xsl:attribute name="name">{=wasteland_clan_4.name}van Haagen</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='wasteland_clan_4']/@text">
    ...
    <xsl:template match="Item[@id='couronne_clan_1']/@name">
        <xsl:attribute name="name">{=couronne_clan_1.name}de Couronne</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='couronne_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='couronne_clan_2']/@name">
        <xsl:attribute name="name">{=couronne_clan_2.name}Chevaliers D'Honneur</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='couronne_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='couronne_clan_3']/@name">
        <xsl:attribute name="name">{=couronne_clan_3.name}Les Hardis de Montmirail</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='couronne_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='anguille_clan_1']/@name">
        <xsl:attribute name="name">{=anguille_clan_1.name}d'Anguille</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='anguille_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='artois_clan_1']/@name">
        <xsl:attribute name="name">{=artois_clan_1.name}d'Artois</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='artois_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='gisoreux_clan_1']/@name">
        <xsl:attribute name="name">{=gisoreux_clan_1.name}de Gisoreux</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='gisoreux_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='parravon_clan_1']/@name">
        <xsl:attribute name="name">{=parravon_clan_1.name}de Parravon</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='parravon_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='montfort_clan_1']/@name">
        <xsl:attribute name="name">{=montfort_clan_1.name}de Montfort</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='montfort_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='bastonne_clan_1']/@name">
        <xsl:attribute name="name">{=bastonne_clan_1.name}de Bastonne</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='bastonne_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='bastonne_clan_2']/@name">
        <xsl:attribute name="name">{=bastonne_clan_2.name}de Garamont</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='bastonne_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='bordeleaux_clan_1']/@name">
        <xsl:attribute name="name">{=bordeleaux_clan_1.name}de Bordeleaux</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='bordeleaux_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='brionne_clan_1']/@name">
        <xsl:attribute name="name">{=brionne_clan_1.name}de Brionne</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='brionne_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='quenelles_clan_1']/@name">
        <xsl:attribute name="name">{=quenelles_clan_1.name}de Quenelles</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='quenelles_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='quenelles_clan_2']/@name">
        <xsl:attribute name="name">{=quenelles_clan_2.name}Beloved of the Fey</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='quenelles_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='aquitaine_clan_1']/@name">
        <xsl:attribute name="name">{=aquitaine_clan_1.name}de Aquitaine</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='aquitaine_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='carcassonne_clan_1']/@name">
        <xsl:attribute name="name">{=carcassonne_clan_1.name}de Carcassonne</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='carcassonne_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='carcassonne_clan_2']/@name">
        <xsl:attribute name="name">{=carcassonne_clan_2.name}Chosen of the Lady</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='carcassonne_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='mousillon_clan_1']/@name">
        <xsl:attribute name="name">{=mousillon_clan_1.name}de Mousillon</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='mousillon_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='mousillon_clan_2']/@name">
        <xsl:attribute name="name">{=mousillon_clan_2.name}Chateau Hane</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='mousillon_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='moot_clan_1']/@name">
        <xsl:attribute name="name">{=moot_clan_1.name}Halflings</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='moot_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_1']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_1.name}Talsyn</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_2']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_2.name}Anmyr</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_3']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_3.name}Atylwyth</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_4']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_4.name}Argwylon</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_4']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_5']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_5.name}Arranoc</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_5']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_6']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_6.name}Cavaroc</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_6']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_7']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_7.name}Cythral</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_7']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_8']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_8.name}Fyr Darric</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_8']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_9']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_9.name}Modryn</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_9']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_10']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_10.name}Tirsyth</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_10']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_11']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_11.name}Torgovann</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_11']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_12']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_12.name}Wydrioth</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_12']/@text">
    ...
    <xsl:template match="Item[@id='athel_loren_clan_13']/@name">
        <xsl:attribute name="name">{=athel_loren_clan_13.name}Sisters of Twilight</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='athel_loren_clan_13']/@text">
    ...
    <xsl:template match="Item[@id='laurelorn_clan_1']/@name">
        <xsl:attribute name="name">{=laurelorn_clan_1.name}Wardens of the Sun</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='laurelorn_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='laurelorn_clan_2']/@name">
        <xsl:attribute name="name">{=laurelorn_clan_2.name}Wardens of the Rains</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='laurelorn_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='laurelorn_clan_3']/@name">
        <xsl:attribute name="name">{=laurelorn_clan_3.name}Wardens of the Storms</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='laurelorn_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='beastmen_clan_1']/@name">
        <xsl:attribute name="name">{=beastmen_clan_1.name}Beastmen</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='beastmen_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='druchii_clan_1']/@name">
        <xsl:attribute name="name">{=druchii_clan_1.name}Druchii Slavers</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='druchii_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='empire_deserter_clan_1']/@name">
        <xsl:attribute name="name">{=empire_deserter_clan_1.name}Empire Deserter Clan</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='empire_deserter_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='troubadours_clan_1']/@name">
        <xsl:attribute name="name">{=troubadours_clan_1.name}de Troubadour</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='troubadours_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='bowmen_bergerac_clan_1']/@name">
        <xsl:attribute name="name">{=bowmen_bergerac_clan_1.name}The Bowmen of Bergerac</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='bowmen_bergerac_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='pesant_knight_clan_1']/@name">
        <xsl:attribute name="name">{=pesant_knight_clan_1.name}The Fellowship of the Peasant Knight</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='pesant_knight_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='dog_clan_2']/@name">
        <xsl:attribute name="name">{=dog_clan_2.name}The Cursed Company</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='dog_clan_2']/@text">
    ...
    <xsl:template match="Item[@id='dog_clan_1']/@name">
        <xsl:attribute name="name">{=dog_clan_1.name}Braganza's Besiegers</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='dog_clan_1']/@text">
    ...
    <xsl:template match="Item[@id='dog_clan_3']/@name">
        <xsl:attribute name="name">{=dog_clan_3.name}Leopold's Leopard Company</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='dog_clan_3']/@text">
    ...
    <xsl:template match="Item[@id='dog_clan_4']/@name">
        <xsl:attribute name="name">{=dog_clan_4.name}Voland's Venator</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='dog_clan_4']/@text">
    ...
    <xsl:template match="Item[@id='dog_clan_5']/@name">
        <xsl:attribute name="name">{=dog_clan_5.name}Marksmen of Miragliano</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='dog_clan_5']/@text">
    ...
    <xsl:template match="Item[@id='dog_clan_6']/@name">
        <xsl:attribute name="name">{=dog_clan_6.name}Ricco's Republican Guard</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='dog_clan_6']/@text">
    ...
    <xsl:template match="Item[@id='dog_clan_7']/@name">
        <xsl:attribute name="name">{=dog_clan_7.name}Al Muktar's Desert Dogs</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='dog_clan_7']/@text">
    ...
    <xsl:template match="Item[@id='chs_cult_1']/@name">
        <xsl:attribute name="name">{=chs_cult_1.name}Cult of the Broken Wheel</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='chs_cult_1']/@text">
    ...
    <xsl:template match="Item[@id='chs_cult_2']/@name">
        <xsl:attribute name="name">{=chs_cult_2.name}Cult of Illumination</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='chs_cult_2']/@text">
    ...
    <xsl:template match="Item[@id='chs_cult_3']/@name">
        <xsl:attribute name="name">{=chs_cult_3.name}Fraternity of the Second Flesh</xsl:attribute>
    </xsl:template>

    <xsl:template match="Item[@id='chs_cult_3']/@text">
