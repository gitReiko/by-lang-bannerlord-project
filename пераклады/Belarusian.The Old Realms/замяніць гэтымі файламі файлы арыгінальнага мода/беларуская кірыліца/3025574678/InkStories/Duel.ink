...
...
{PlayerWin: 
Калі суціхае звон мячоў, у паветры раздаюцца радасныя воклічы вашых паплечнікаў, што адлюстроўваюць наступствы вашай нялёгкай перамогі. {SetPlayerCustomTag("DefeatedVittorio")}}
