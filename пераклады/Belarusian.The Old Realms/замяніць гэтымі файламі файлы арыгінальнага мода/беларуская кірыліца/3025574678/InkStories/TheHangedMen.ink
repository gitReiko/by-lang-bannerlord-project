...
===Start===
    Вы натыкаецеся на дрэва, на якім вісяць тры чалавекі з мячом, уваткнутым у зямлю пад імі. Падыдучы бліжэй, вы бачыце, што на дрэве выдрапана слова "Здраднікі", а меч выкарыстоўваецца для пазначэньня магілы. #STR_Start1 ->choice1
    ...
    =choice2
        ...
        *{DugUpGrave && PartyCanRaiseDead && not LootedBody}[Ажывіць цела нябожчыка ў якасьці прывіда (+1 Вартаўнік Склепа, Літасьць--) {print_party_skill_chance("Spellcraft", RaiseDeadDifficulty)}]
            ~AddTraitInfluence("Mercy", -50)
                ...
                {CryptGuardSuccess: Вашая партыя пасьпяхова ажыўляе цела ў якасьці прывіда. {TookSword: Прывід уздымаецца і працягвае руку, нібы просячы вярнуць яму меч. Вы вяртаеце яму зброю.} Ён далучаецца да астатніх вашых сілаў. ->Leave | Вашая партыя няўдала спрабуе ажывіць цела ў якасьці прывіда.->choice2} #STR_DigResurrect
            ->Leave

===Leave===
    Прыняўшы разьвязак, вы рушыце далей. #STR_Leave1
    {HaveSword: 
